package com.dcl.javacv.serialport.ui;
...
import com.dcl.javacv.serialport.presenter.MainPresenter;
import com.dcl.javacv.serialport.ui.login.LoginActivity;
import com.dcl.javacv.serialport.view.GiveLikeView;
...
//        mImage.setImageResource(R.mipmap.designbump);
//        //预加载图片
//        Glide.with(this)
//                .load(url)
//                .preload();
...
//                .into(mImage);
    ...
    public void onImageClicked() {
        ObjectAnimator animatorY = ObjectAnimator.ofFloat(mImage, "scaleY", 1f, 0.3f);
        ObjectAnimator animatorX = ObjectAnimator.ofFloat(mImage, "scaleX", 1f, 0.3f);
        ObjectAnimator animatorY2 = ObjectAnimator.ofFloat(mImage, "scaleY", 0.3f, 1.2f, 1f);
        ObjectAnimator animatorX2 = ObjectAnimator.ofFloat(mImage, "scaleX", 0.3f, 1.2f, 1f);
        AnimatorSet animatorSet = new AnimatorSet();
        animatorSet.playTogether(animatorY, animatorX);
        animatorSet.setDuration(150);
        animatorSet.start();
        AnimatorSet animatorSet2 = new AnimatorSet();
        animatorSet2.playTogether(animatorY2, animatorX2);
        animatorSet2.setDuration(200);
        animatorSet.addListener(new AnimatorListenerAdapter() {
            @Override
            public void onAnimationEnd(Animator animation) {
                super.onAnimationEnd(animation);
                mImage.setImageResource(R.mipmap.hearmysite);
                animatorSet2.start();
            }
        });
    }

    @OnClick(R.id.grid_view_image)
    public void onGridViewImageClicked() {
        mGridViewImage.setMaxRectHeight(160);
        mGridViewImage.open();
    }
